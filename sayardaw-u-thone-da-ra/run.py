...
'''
playlist = 'ဆရာေတာ္ႀကီး ဦးသုႏၵရ ေဟာၾကားေတာ္မူခဲ့ေသာ တရားေတာ္မ်ား'
description_title = 'ပခုကၠဴၿမိဳ႕ ပင္မမိုးကုတ္ဝိပႆနာ မဂၤလာရိပ္သာ ပဓာန နာယက နယ္လွည့္သာသနာျပဳ ဆရာေတာ္ႀကီး ဦးသုႏၵရ ေဟာၾကားေတာ္မူခဲ့ေသာ တရားေတာ္မ်ား'
