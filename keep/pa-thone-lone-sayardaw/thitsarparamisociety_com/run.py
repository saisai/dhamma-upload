...
def get_json_new():    
    ...
    playlist = 'ပသံုးလံုး ဝိပႆနာျပန္႔ပြားေရးအဖြဲ႕ခ်ဳပ္ ဘဒၵႏ ၱေဇာတိက ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'ပသံုးလံုး ဝိပႆနာျပန္႔ပြားေရးအဖြဲ႕ခ်ဳပ္ ဘဒၵႏ ၱေဇာတိက ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
