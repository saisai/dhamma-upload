...
def get_json_new():    
    ...
    playlist = 'အရွင္ဝိလာသဂၢ (သဒၶမၼရံသီရိပ္သာ)သစၥာေရႊျပည္ဆရာေတာ္ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'ေဗာဓိၿမိဳင္ သစၥာေရႊျပည္ ဓမၼရိပ္သာ ႏွင့္ လွည္းကူးၿမိဳ႕နယ္ ကၽြန္းကေလးေက်းရြာ ျမတ္သႏၷာမဟာစည္သာသနာ့ရိပ္သာတို႔၏ ဦးစီးပဓာနနာယကဆရာေတာ္ အရွင္ဝိလာသဂၢ (သဒၶမၼရံသီရိပ္သာ)သစၥာေရႊျပည္ဆရာေတာ္ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
