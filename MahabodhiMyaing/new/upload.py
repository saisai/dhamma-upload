...
count = len(titles)
name = []
description = "ေက်းဇူးရွင္ မဟာေဗာဓိၿမိဳင္ဆရာေတာ္ဘုရားႀကီး ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား"
for title in reversed(titles):
    ...
    count -= 1
playlist = "မဟာေဗာဓိၿမိဳင္ဆရာေတာ္ဘုရားႀကီး ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား"
