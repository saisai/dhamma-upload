...
#check_duplicate('titles_links.txt') #titles_links.txt
...
'''
playlist = 'ဆရာေတာ္ အရွင္သီလာနႏၵာဘိဝံသ (D.Litt) သင္တန္း တရားေတာ္မ်ား'
description_title = 'ဆရာေတာ္ အရွင္သီလာနႏၵာဘိဝံသ (D.Litt)  (December 16, 1927---August 13, 2005) (အဂၢမဟာပ႑ိတ - အဂၢမဟာသဒၶမၼေဇာတိကဓဇ) ပါေမာကၡခ်ဳပ္ဆရာေတာ္ အျပည္ျပည္ဆိုင္ရာေထရဝါဒဗုဒၶသာသနာျပဳတကၠသိုလ္၊ ရန္ကုန္။ အဘိဓမၼာ သင္တန္း ပို႔ခ်ခ်က္မ်ား ႏွင့္ အေျခခံဗုဒၶဘာသာသင္တန္း တရားေတာ္မ်ား'
