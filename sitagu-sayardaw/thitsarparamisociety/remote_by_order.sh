...
#rsync -P -avzzz *.mp4 -e 'ssh -p 8022 -i /cygdrive/d/jcy/sms_copy/ssh_keygen/this' u0_a95@192.168.1.54:/data/data/com.termux/files/home/youtube/sitagu-sayardaw/

for i in `ls -1 *.mp4 | sort -n`
do
    echo $i;
    rsync -P -avzzz $i -e 'ssh -p 8022 -i /cygdrive/d/jcy/sms_copy/ssh_keygen/this' u0_a95@192.168.1.54:/data/data/com.termux/files/home/youtube/sitagu-sayardaw/
done
