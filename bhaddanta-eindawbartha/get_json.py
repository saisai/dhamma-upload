...
description_title = "ေက်းဇူးေတာ္ရွင္ ဓမၼာႏုပႆနာ ပခုကၠဴ ဆရာေတာ္ဘုရားႀကီး ဘဒၵႏၲ ဣေႏၵာဘာသ အနိစၥဆရာေတာ္ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား"
source = "\nsource from https://www.thitsarparamisociety.com"


results = []    
count = 1
playlist = "ပခုကၠဴ ဆရာေတာ္ဘုရားၾကီး ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား"
