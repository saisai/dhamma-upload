...
#breaker_in_order(get_results('titles_links.txt'))

#for txt in breaker_in_order(get_results('titles_links.txt')):
#for txt in get_results('titles_links.txt'):
...
def get_json_file():
    ...
    playlist = 'ေက်းဇူးေတာ္ရွင္ ဓမၼာႏုပႆနာ ပခုကၠဴ ဆရာေတာ္ဘုရားႀကီး ဘဒၵႏၲ ဣေႏၵာဘာသ အနိစၥဆရာေတာ္ ေဟာႀကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'ပင္လုံဝိဟာရေက်ာင္း၊ ေတဇိႏၵရာမေက်ာင္းတိုက္၊ ကုကၠိဳင္းလမ္းဆုံ၊ ကမာၻေအးဘုရားလမ္း၊ ဗဟန္းၿမိဳ႕နယ္၊ ရန္ကုန္ၿမိဳ႕။ ေက်းဇူးေတာ္ရွင္ ဓမၼာႏုပႆနာ ပခုကၠဴ ဆရာေတာ္ဘုရားႀကီး ဘဒၵႏၲ ဣေႏၵာဘာသ အနိစၥ ဆရာေတာ္ ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား'
    source='\nsource from https://www.thitsarparamisociety.com/bhaddanta-eindawbartha/' 
