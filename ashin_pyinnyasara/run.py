...
def get_json_new():    
    ...
    playlist = 'သစၥာဂုဏ္သင္း ဆရာေတာ္ အရွင္ပညာစာရ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'သစၥာဂုဏ္သင္း ဆရာေတာ္ အရွင္ပညာစာရ သာသနဓဇ ဓမၼာစရိယ၊ သာသနေဇာတိပါလ ဓမၼာစရိယ၊ ပရိယတၱိသဒၶမၼဟိတ ဓမၼာစရိယ၊ ဝိနယဝိဒူ၊ ကမၼဌာနစရိယ (ေအာင္စၾကာစာသင္တိုက္၊ မိုးကုတ္ဝိပႆနာ ဓမၼရိပ္သာ၊ သန္လွ်င္ၿမိဳ႕)'
