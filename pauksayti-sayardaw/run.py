...
def get_json_new():    
    ...
    playlist = 'ေပါက္ေစတီဆရာေတာ္ႀကီး ဦးသုမိတၱာဘိဝံသ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'ေပါက္ေစတီဆရာေတာ္ႀကီး ဦးသုမိတၱာဘိဝံသ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
