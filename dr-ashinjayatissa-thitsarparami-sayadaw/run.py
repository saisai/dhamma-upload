...
def get_json_new():    
    ...
    playlist =  'သစ္စာပါရမီဆရာတော် ဒေါက်တာအရှင်ဇယတိဿ (သာသနဓဇဓမ္မစရိယ M.A,Ph.D ) ဟောကြားတော်မူသော တရားတော်များ'
    description_title = 'သစ္စာပါရမီဆရာတော် ဒေါက်တာအရှင်ဇယတိဿ (သာသနဓဇဓမ္မစရိယ M.A,Ph.D ) ဟောကြားတော်မူသော တရားတော်များ'
    source='\nsource from http://www.thitsarparamisociety.com/' 
