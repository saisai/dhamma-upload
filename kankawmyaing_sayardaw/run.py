...
def get_json_new():    
    ...
    playlist = 'ကံ့ေကာ္ၿမိဳင္ဆရာေတာ္ ဘဒၵႏၲသာသန (အဂၢမဟာဂႏၶ ဝါစက ပဏၰိတ) ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'ကံ့ေကာ္ၿမိဳင္ဆရာေတာ္ ဘဒၵႏၲသာသန (အဂၢမဟာဂႏၶ ဝါစက ပဏၰိတ) ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
