...
description_title ="သာသနဓဇ။ သဒၶမၼေနပုည။ သာသနေဇာတိပါလ ဓမၼာစရိယ။ ဓမၼကထိက ဗဟုဇနဟိတဓရ ဓမၼဒူတ ေဒါက္တာ အရွင္ ေဆကိႏၵ ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား"
source = "\nsource from http://www.dhammadownload.com"


results = []    
count = 1
playlist = "ဓမၼဒူတ ေဒါက္တာ အရွင္ ေဆကိႏၵ ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား"
