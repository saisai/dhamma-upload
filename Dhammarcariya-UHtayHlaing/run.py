...
def get_json_new():    
    ...
    playlist = 'ဓမၼာစရိယ ဦးေဌးလိွုင္ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'ေက်းဇူးရွင္ မဟာကမၼဌာနာစရိယ ေမာင္ေထာင္ေျမဇင္းေတာရ ဆရာေတာ္ဘုရားၾကီး၏ နိဗၺာနမဂၢ အာနာပါန သမထ ၀ိပသနာ အားထုတ္နည္းအတိုင္း(ကႏၷီနည္း) ဓမၼာစရိယ ဦးေဌးလိွုင္ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
