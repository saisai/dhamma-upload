...
def get_json_new():    
    ...
    playlist = 'သီတဂူ အရွင္ေဒဝိႏၵာဘိဝံသ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'သီတဂူ အရွင္ေဒဝိႏၵာဘိဝံသ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    source='\nsource from http://thitsarparamisociety.com' 
