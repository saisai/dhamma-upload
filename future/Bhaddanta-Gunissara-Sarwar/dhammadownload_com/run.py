...
def get_json_new():    
    ...
    playlist = 'ေျမာင္းျမၿမိဳ႕ တိုက္သစ္ပေဇၨာတာရုံေက်ာင္းတိုက္ ပဓာန နာယကဆရာေတာ္ ဘဒၵႏ ၱဂုဏိႆရ ဓမၼာစရိယ စာဝါမ်ား'
    description_title = 'ေျမာင္းျမၿမိဳ႕ တိုက္သစ္ပေဇၨာတာရုံေက်ာင္းတိုက္ ပဓာန နာယကဆရာေတာ္ ဘဒၵႏ ၱဂုဏိႆရ  ဓမၼာစရိယ စာသင္သားမ်ားအတြက္ စာခ်တန္း(၃)က်မ္းအတြက္စာဝါမ်ား အသံဖိုင္မ်ား'
