...
#update_raw_titles_links_mp3_and_title('raw_titles_links.txt', 'titles_links_2.txt', 1)
#convert_myanmar_number_option('raw_titles_links.txt', 'titles_links.txt', 1)
#breaker_in_order(get_results('desc_links.txt'))
#add_extra_description(get_results('titles_links_desc.txt'))


#convert_myanmar_number('titles_links.txt', 'description.txt') # titles_links.txt description.txt
def get_new_json():
    playlist = 'ဟဲသိမ်ပတ္တမြားတောင် ဆရာတော်ဦးကောဝိဒ ဟောကြားတော်မူသောတရားတော်များ'
    description_title = 'ဟဲသိမ်ပတ္တမြားတောင် ဆရာတော်ဦးကောဝိဒ ဟောကြားတော်မူသောတရားတော်များ'
