...
def get_json_new():    
    ...
    playlist = 'သဇင္ ေရ ေက်ာ္ ဆရာ ေတာ္အရွင္ဥာ ေဏာ ဘာသ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'သဇင္ ေရ ေက်ာ္ ဆရာ ေတာ္အရွင္ဥာ ေဏာ ဘာသ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    ...
    get_json('edited_titles_links.txt', 'description.txt', 'raw_json_title.txt',playlist, description_title, source) #titles_links.txt description.txt raw_json_title.txt
