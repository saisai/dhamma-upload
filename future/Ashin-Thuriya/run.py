...
def get_json_new():    
    ...
    playlist = 'ေမတၱဂူဆရာေတာ္ ေဒါက္တာအရွင္သူရိယ ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား'
    description_title = 'ေမတၱဂူဆရာေတာ္ ေဒါက္တာအရွင္သူရိယ ျပင္ဦးလြင္ျမိဳ႕ ခ်မ္းေျမ႔ျမိုင္ရိပ္သာေက်ာင္းနွင္႔ ေမတၱဂူေတာရ ဓမၼရိပ္သာေက်ာင္းတို႔တြင္ ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား'
