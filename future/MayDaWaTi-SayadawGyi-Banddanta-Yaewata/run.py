...
def get_json_new():    
    ...
    playlist = 'ေက်းဇူးရွင္ ေမဃဝတီ ဆရာေတာ္ဘုရားႀကီး သီရိ ဘဒၵႏ ၱေရဝတ မဟာေထရ္ ရြတ္ဆို ပူေဇာ္ေသာ ပရိတ္ တရားေတာ္မ်ား'
    description_title = 'ေက်းဇူးရွင္ ေမဃဝတီ ဆရာေတာ္ဘုရားႀကီး သီရိ ဘဒၵႏ ၱေရဝတ မဟာေထရ္ ရြတ္ဆို ပူေဇာ္ေသာ ပရိတ္ တရားေတာ္မ်ား'
