...
'''  
def get_json():
	playlist = 'အာဂုံမဲ့ သဒၵါ page မွာ videos မ်ား'
	description_title = 'အာဂုံမဲ့ သဒၵါ page မွာ videos မ်ား'
	source='\nsource from https://www.facebook.com/pg/Indobhasa.NM/videos/'
	get_json_fb('titles.txt', 'edited_result.txt', 'raw_json_title.txt',playlist, description_title, source) #titles_links.txt description.txt raw_json_title.txt
