...
from crawler import (get_fb_title, rearrange_urls, download_fb,
                    ...
                    thread_upload_test_title,get_json_files_in_same,get_json_fb_2)
...
'''
def get_json():
	playlist = 'စစ္ကိုင္း တိပိဋက ဆရာေတာ္ LIVE မွ videos မ်ား'
	description_title = 'စစ္ကိုင္း တိပိဋက ဆရာေတာ္ LIVE မွ videos မ်ား'
	source='\nsource from https://www.facebook.com/pg/စစ္ကိုင္း တိပိဋက ဆရာေတာ္ LIVE-624942624603663/videos/'
