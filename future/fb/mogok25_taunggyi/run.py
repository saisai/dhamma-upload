...
'''  
def get_json():
	playlist = 'Mogok Vipassana Dhamma Yeik Thar Taunggyi Branch-25 page မွာ videos မ်ား'
	description_title = 'Mogok Vipassana Dhamma Yeik Thar Taunggyi Branch-25 page မွာ videos မ်ား'
	source='\nsource from https://www.facebook.com/mogok25.taunggyi/videos/'
