...
#get_fb_duration('links.txt', 'duration.txt', 'duration_finished.txt', '../geckodriver', 3)
#get_fb_duration('redo.txt', 'duration_edited.txt', 'finished_edited.txt', '../geckodriver', 1)
