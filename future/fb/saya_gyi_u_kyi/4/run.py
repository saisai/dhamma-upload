...
def get_json():
	...
	get_json_files_in_same('edit_result.txt', 'edit_result.txt', 'raw_json_title.txt',playlist, description_title, source) #titles_links.txt description.txt raw_json_title.txt
