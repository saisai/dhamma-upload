...
def get_json():
	playlist = 'မဟာစည်ဆရာတော်ကြီးနှင့် ဗုဒ္ဓမြတ်စွာသာသနာ Ven. Mahasi Sayadaw & Buddha Sasana မှ Videos များ'
	description_title = 'မဟာစည်ဆရာတော်ကြီးနှင့် ဗုဒ္ဓမြတ်စွာသာသနာ Ven. Mahasi Sayadaw & Buddha Sasana မှ Videos များ'
	source='\nsource from https://www.facebook.com/pg/WinNaingKyawfromYangon/videos/'
