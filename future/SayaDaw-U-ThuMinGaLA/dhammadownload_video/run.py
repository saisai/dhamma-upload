...
'''
for url in get_line_from_file('raw_titles_links.txt'):
    print(url)
...
playlist = 'မဂၤလာတိုက္ ဆရာေတာ္ ဥဳးသုမဂၤလ (ဒယ္အိုး ဆရာေတာ္) ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
description_title = 'ေမွာ္ဘီ မဂၤလာတိုက္ ဗုဒၵဘာသာ တရားစဥ္ ႏွင့္ လုပ္ငန္းစဥ္ ျပန္႕ပြားေရး တရား႒ာန၏ ဦးစီးပဓာန နာယက၊ ဓမၼကထိက ဒယ္အိုးဆရာေတာ္ ဥဳးသုမဂၤလ ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား'
