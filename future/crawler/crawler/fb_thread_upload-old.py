...
class Job:
    ...
    def __init__(self, priority, playlist, title, description, id):
...
class Converter(Thread):
    ...
    def run(self):
        while True:
            ...
            mp3file = str('{}'.format(getObj.id)) + '.mp4'
...
class ConvertManager():
    ...
    def begin_convert(self):
        ...
        for key in self.convert_list:
            ...
            #priority, playlist, title, description, id)
            #print(int(key['priority']), key['playlist'], key['title'] ,key['description'], key['id'])
            queue.put(Job(int(key['priority']), key['playlist'], key['title'] ,key['description'], key['id']))  
