...
def get_json_new():    
    ...
    playlist = 'မဟာကမၼ႒ာနာစရိယ ဓာတ္လယ္ဆရာေတာ္ ဘဒၵႏ ၱသုဝဏၰ မဟာေထရ္ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'မဟာကမၼ႒ာနာစရိယ ဓာတ္လယ္ဆရာေတာ္ ဘဒၵႏ ၱသုဝဏၰ မဟာေထရ္ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
