...
def get_json_new():    
    ...
    playlist = 'မန္တလေးမြို့၊ မလွန်ဈေးဆန်လှူအသင်းကြီးမှ ကြီးမှူးကျင်းပသော တရားတော်များ'
    description_title = 'မန္တလေးမြို့၊ မလွန်ဈေးဆန်လှူအသင်းကြီးမှ ကြီးမှူးကျင်းပသော တရားတော်များ'
    source='\nsource from https://thitsarparamisociety.com' 
