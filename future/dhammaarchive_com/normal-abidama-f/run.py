...
def get_json_new():    
    ...
    playlist = 'အဘိဓမၼတၳသဂၤဟက်မ္း (သၿဂႋဳဟ္က်မ္း) အပိုင္းကိုးပိုင္း'
    description_title ='အဘိဓမၼတၳသဂၤဟက်မ္း (သၿဂႋဳဟ္က်မ္း) အပိုင္းကိုးပိုင္း'
    source='\nsource from http://www.dhammaarchive.com/normal-abidama-t/' 
