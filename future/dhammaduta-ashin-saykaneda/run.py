...
def get_json_new():    
    ...
    playlist = 'ဓမၼဒူတဆရာေတာ္ ေဒါက္တာ အရွင္ေဆကိႏၵ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'ဓမၼဒူတဆရာေတာ္ ေဒါက္တာ အရွင္ေဆကိႏၵ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
