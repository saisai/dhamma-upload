...
#get_html_mp3_option('raw_html.txt', 'raw_titles_links.txt', 'http://www.myaseintaung.net/video/', 1)
...
'''
playlist = 'အရွင္ဇဝန (ေမတၲာရွင္) ေရႊျပည္သာ ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား'
description_title = 'အရွင္ဇဝန (ေမတၲာရွင္) ေရႊျပည္သာ ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား'
