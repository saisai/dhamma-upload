...
description_title ="ေညာင္တုန္း ဆရာေတာ္ ဘဒၵႏ ၱေဇာတိကဘိဝံသ သာသနဓဇဓမၼာစရိယ၊ သာသနပါလဓမၼာစရိယ၊ ဥဘေတာဝိဘဂၤဓရ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား"
source = "\nsource from http://www.dhammadownload.com"


results = []    
count = 1
playlist = "ေညာင္တုန္း ဆရာေတာ္ ဘဒၵႏ ၱေဇာတိကဘိဝံသ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား"
