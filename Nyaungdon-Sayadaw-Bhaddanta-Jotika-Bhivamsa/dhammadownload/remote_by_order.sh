...
rsync -P -avzzz thread_download.py -e 'ssh -p 8022 -i /cygdrive/d/jcy/sms_copy/ssh_keygen/this' u0_a95@192.168.1.54:/data/data/com.termux/files/home/youtube/Nyaungdon-Sayadaw-Bhaddanta-Jotika-Bhivamsa/dhammadownload/
rsync -P -avzzz *.txt -e 'ssh -p 8022 -i /cygdrive/d/jcy/sms_copy/ssh_keygen/this' u0_a95@192.168.1.54:/data/data/com.termux/files/home/youtube/Nyaungdon-Sayadaw-Bhaddanta-Jotika-Bhivamsa/dhammadownload/
