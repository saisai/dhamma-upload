...
source = "\nအဘိဓမၼာ (ဂုဏ္ထူးေဆာင္) ဋီကာေက်ာ္ ပထမဆင့္၊ ဒုတိယဆင့္၊ တတိယဆင့္\nsource from http://www.dhammadownload.com"


results = []    
count = 224
playlist = "အဘိဓမၼာ (ဂုဏ္ထူးေဆာင္) ဋီကာေက်ာ္ ဒုတိယဆင့္ သင္တန္းမွဴး၊ ဓမၼဗ်ဴဟာ ေခၚခင္လွတင္(မဟာသဒၶမၶေဇာတိကဓဇ) ပို႔ခ်ေသာ အထူးအဘိဓမၼာက်င့္စဥ္သင္တန္း  ရုပ္/သံ မ်ား"
