...
def get_json_new():    
    ...
    playlist = 'အဘိဓမ္မာဂုဏ်ထူးဆောင် (ဋီကာကျော်) ပထမဆင့် အနီးကပ်သင်တန်း  စိတ်ပိုင်းစေတသိက်ပိုင်း ပကိဏ်းပိုင်း (၂၀၁၉)'
    ...
    get_json_files_in_same('titles.txt', 'titles_links.txt', 'raw_json_title.txt',playlist, description_title, source) #titles_links.txt description.txt raw_json_title.txt
