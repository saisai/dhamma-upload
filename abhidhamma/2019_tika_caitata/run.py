...
#onvert_myanmar_number_option('raw_titles_links.txt', 'titles_links.txt', 1)
...
def get_json_new():    
    ...
    playlist = 'ပထမကြီးတန်းအတွက် ဆန်းဘာသာ ပို့ချလမ်းညွှန်မှုစာဝါမှတ်တမ်း'
    description_title = 'ပထမကြီးတန်းအတွက် ဆန်းဘာသာ ပို့ချလမ်းညွှန်မှုစာဝါမှတ်တမ်း'
    source='\nsource from https://www.facebook.com/sila.vansa' 
