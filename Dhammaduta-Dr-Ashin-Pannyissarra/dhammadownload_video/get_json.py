...
description_title ="ဓမၼဒူတ ေဒါက္တာအရွင္ပညိႆရာ ဘိဝံသ B.A(Myanmar) M.A (Sri Lanka) Ph.D (India) သာသနဓဇ ဓမၼာစရိယ သာသနေဇာတိပါလဒမၼာစရိယ၊ သာသနဟိတဂဏဝါစကာစရိယ၊ မဟာဂႏ ၱဝါစကပ႑ိတ ေဟာၾကားေတာ္မူေသာတရားေတာ္မ်ား"
source = "\nsource from http://www.dhammadownload.com"


results = []    
count = 1
playlist = "ဓမၼဒူတ ေဒါက္တာအရွင္ပညိႆရာ ဘိဝံသ ေဟာၾကားေတာ္မူေသာတရားေတာ္မ်ား"
