...
def get_json_new():    
    ...
    playlist = 'မဏိရတနာေက်ာင္းဆရာေတာ္ ဘဒၵႏ ၱ ပ႑ိတ(ဒိြပိဋကဓရ) ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'မဏိရတနာေက်ာင္းဆရာေတာ္ ဘဒၵႏ ၱ ပ႑ိတ(ဒိြပိဋကဓရ)မဟာဂႏ ၳဝါစကပ႑ိတ( မဏိရတနာေက်ာင္း)၊ေျခာက္ထပ္ႀကီးဘုရားႀကီးတိုက္၊ဗဟန္းၿမိဳ႕နယ္၊ရန္ကုန္ၿမိဳ႕။'
