...
description_title = "ျဖဴးမဟာစည္ သာသနာရိပ္သာ မဓာနနာယက သာသနဓဇ ဓမၼာစရိယ၊ ဓမၼကထိက ဗဟုဇန ဟိတဓရ ျဖဴးဆရာေတာ္ ဘဒၵႏ ၱနရပတိ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား"
source = "\nsource from https://www.thitsarparamisociety.com"


results = []    
count = 1
playlist = "ျဖဴးဆရာေတာ္ ဘဒၵႏ ၱနရပတိ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား"
