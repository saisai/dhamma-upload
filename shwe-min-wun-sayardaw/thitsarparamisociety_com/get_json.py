...
description_title ="ေရႊမင္းဝံဆရာေတာ္ ဘဒၵႏ ၱေသာဘန အဂၢမဟာကမၼ႒ာနာစရိယ၊ အဂၢမဟာသဒၶမေဇာတိကဓဇ မဟာစည္နာယက၊ ျပည္တြင္းျပည္ပ သာသနာျပဳ ေရႊမင္းဝံဆရာေတာ္ဘုရားႀကီး ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား"
source = "\nsource from https://www.thitsarparamisociety.com"


results = []    
playlist = "ေရႊမင္းဝံဆရာေတာ္ ဘဒၵႏ ၱေသာဘန ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား"
