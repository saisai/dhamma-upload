...
def get_json_new():    
    ...
    playlist = 'မဟာဂႏၶာ႐ုံဆရာေတာ္ဘုရားႀကီး အဂၢမဟာပ႑ိတ အရွင္ဇနကာဘိဝံသ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'မဟာဂႏၶာ႐ုံဆရာေတာ္ဘုရားႀကီး အဂၢမဟာပ႑ိတ အရွင္ဇနကာဘိဝံသ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
