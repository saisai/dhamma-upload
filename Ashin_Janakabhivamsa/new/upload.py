...
count = len(titles)
name = []
description = "မဟာဂႏၶာရံုဆရာေတာ္ဘုရားႀကီး အဂၢမဟာပ႑ိတ အရွင္ဇနကာဘိ၀ံသ  (၇.၀၅.၁၉၆၃) မွ (၉.၀၅.၁၉၆၃) ထိ YABA အသင္း ႀကီးမွ ႀကီး မွဴး က်င္းပေသာ ဗုဒၶဘာသာသင္တန္းဖြင့္ပြဲ ႀကီး အတြက္ ၿမိဳ႕မ အမ်ိဳးသမီး ေက်ာင္းတြင္ ေဟာၾကားေသာတရားေတာ္မ်ား"
