...
def get_json_new():    
    ...
    playlist = 'ပါမောက္ခ ဒေါက်တာအရှင်ဓမ္မသာမိ ဟောကြားတော်မူသောတရားတော်များ'
    description_title = 'အဂ္ဂမဟာဂန္တဝါစကပဏ္ဍိတ ၊ အဂ္ဂမဟာသဒ္ဓမ္မဇောတိကဓဇ ကမ္ဘာ့ဗုဒ္ဓသာသနာပြု အောက်စဖိုဒ့် ဆရာတော် ပါမောက္ခ ဒေါက်တာအရှင်ဓမ္မသာမိ DPhil (Oxford)  ပါမောက္ခ ဒေါက်တာအရှင်ဓမ္မသာမိ ဟောကြားတော်မူသောတရားတော်များ'
