...
class Converter(Thread):
    ...
    def download_file(self, mp3file):
        ...
        driver = webdriver.Firefox(firefox_options=opts, executable_path=r'/e/dhamma-upload/aa/ahshinottama/facebook/geckodriver.exe')
...
def main():
    ...
    newmp3s = [f.strip('\n').replace('"', '') for f in open('new_links_upload.txt', 'r')]
    #print(newmp3s)
