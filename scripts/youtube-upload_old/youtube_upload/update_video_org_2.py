...
CLIENT_SECRETS_FILE = '/usr/share/youtube_upload/client_secrets.json'
...
def update_video(youtube, args):
  ...
  if args.playlist_id:
    videos_list_snippet['playlist_id'] = args.playlist_id    
  ...
  if videos_update_response['snippet']['playlist_id']:
    print(('Playlist: ' +
           videos_update_response['snippet']['playlist_id'] + '\n'))           
