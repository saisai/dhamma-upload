...
description_title ="ရန္ကုန္တိုင္း၊ တိုက္ႀကီးၿမိဳ႕နယ္၊ လိေမၼာ္ၿခံေက်းရြာ ျမစိမ္းေတာင္ဆရာေတာ္ ဘဒၵႏၲ ဇာေနယ် ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား"
source = "\nsource from http://www.dhammadownload.com"


results = []    
count = 1
playlist = "ျမစိမ္းေတာင္ဆရာေတာ္ ဘဒၵႏၲ ဇာေနယ် ေဟာႀကားေတာ္မူေသာတရားေတာ္မ်ား"
