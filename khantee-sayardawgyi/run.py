...
def get_json_new():    
    ...
    playlist = 'ခႏၲီးဆရာေတာ္ဘုရားႀကီး ဘဒၵႏၲ သုဇနမဟာေထရ္ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
    description_title = 'ခႏၲီးဆရာေတာ္ဘုရားႀကီး ဘဒၵႏၲ သုဇနမဟာေထရ္ ေဟာၾကားေတာ္မူေသာ တရားေတာ္မ်ား'
